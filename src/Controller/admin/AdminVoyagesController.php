...
class AdminVoyagesController extends AbstractController {
    ...
    public function index (): Response{
        ...
        return $this->render("admin/admin.voyages.html.twig",  ['visites' => $visite
                ]);
    }
    ...
    public function edit(Visite $visite, Request $request): Response{
        ...
        return $this->render("admin/admin.voyage.edit.html.twig", ['visite' => $visite,
    ...
    public function ajout(Request $request): Response{
        ...
        return $this->render("admin/admin.voyage.ajout.html.twig", ['visite' => $visite,
            'formVisite' => $formVisite->createView()
                ]);
    }
